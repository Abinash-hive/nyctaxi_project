...
df = df.groupBy(
    ...
    round(avg("passenger_count"), 1).alias("avg_passenger_per_trip"), # average passengers per trip
    round(avg("trip_distance"), 1).alias("avg_distance_per_trip"),     # average trip distance (miles)
